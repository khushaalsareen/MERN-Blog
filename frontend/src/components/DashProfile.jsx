  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <TextInput type='text' placeholder='username' id='username' defaultValue={currentUser.username}  onChange={(e)=>{
          setFormData({...formData, [e.target.id]:e.target.value})
        }} />
        <TextInput type='email' placeholder='email' id='email' defaultValue={currentUser.email}  onChange={(e)=>{
          setFormData({...formData, [e.target.id]:e.target.value})
        }}/>
        <TextInput type='password' placeholder='password' id='password' onChange={(e)=>{
          setFormData({...formData, [e.target.id]:e.target.value})
        }}  />
